...
Some potential speakers get blocked at the earliest stage: deciding what they should talk about.

Here are a few guidelines for choosing a topic that has the possibility of turning into a good talk.
...
The first talk I ever gave was on vim, a text editor I'd been using for five years nearly every day. I'd seen my coworkers using it far less efficiently and figured that if they needed some pointers, other developers would too.
